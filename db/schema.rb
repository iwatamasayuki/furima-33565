...
ActiveRecord::Schema.define(version: 2021_01_28_122729) do
  ...
  create_table "streets", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["purchase_record_id"], name: "index_streets_on_purchase_record_id"
  end
  ...
  add_foreign_key "streets", "purchase_records"
end
