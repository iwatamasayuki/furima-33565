class PurchaseForm
  ...
  Street.create(postal: postal, prefecture_id: prefecture_id, minicipalities: minicipalities, residence: residence, building: building, phone: phone, purchase_record_id: purchase_record.id)
  end
end